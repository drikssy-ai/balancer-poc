...
import { MockAuthorizerAdaptorEntrypoint } from "@balancer/contracts/test/MockAuthorizerAdaptorEntrypoint.sol";
import { TimelockAuthorizer } from "@balancer/contracts/authorizer/TimelockAuthorizer.sol";
import { Vault } from "@balancer/contracts/Vault.sol";
import { IWETH } from "@balancer/contracts/interfaces/solidity-utils/misc/IWETH.sol";
import { IAuthorizerAdaptorEntrypoint } from
    "@balancer/contracts/interfaces/liquidity-mining/IAuthorizerAdaptorEntrypoint.sol";
import { ProtocolFeePercentagesProvider } from "@balancer/contracts/ProtocolFeePercentagesProvider.sol";
